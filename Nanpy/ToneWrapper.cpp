...
void nanpy::ToneWrapper::playRTTTL(int songIndex) {
#if defined(__AVR__)
    
    setup_rtttl(pin);
    play_rtttl(songs[songIndex]);
    
#endif
}

void nanpy::ToneWrapper::testRTTTL() {
#if defined(__AVR__)
    
    setup_rtttl(pin);
//    play_rtttl("MissionImp:d=16,o=6,b=95:32d,32d#,32d,32d#,32d,32d#,32d,32d#,32d,32d,32d#,32e,32f,32f#,32g,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,a#,g,2d,32p,a#,g,2c#,32p,a#,g,2c,a#5,8c,2p,32p,a#5,g5,2f#,32p,a#5,g5,2f,32p,a#5,g5,2e,d#,8d");
    
#endif
}


void nanpy::ToneWrapper::testString(char* song) {
#if defined(__AVR__)
...
void nanpy::ToneWrapper::testInt(int song) {
#if defined(__AVR__)
...
//
//
//void nanpy::ToneWrapper::startRTTTL(char* newHeader) {
//#if defined(__AVR__)
//    
//    String popped;
//    
//    while (popped = notes.pop());
//    
...
//}
//
//void nanpy::ToneWrapper::addRTTTLNote(char* note) {
//    notes.push(String(note));
//}
//
//void nanpy::ToneWrapper::playStreamedRTTTL() {
//    
//    String rtttl = header;
//    
//    String popped;
...
//    }
//    
//    char rtttlStr[rtttl.length()+1];
//    
//    rtttl.toCharArray(rtttlStr,rtttl.length());
//    
//    
//    play_rtttl(rtttlStr);
//    
